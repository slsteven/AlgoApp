...
console.log("configAuth", configAuth.facebookAuth.clientID)
console.log("configAuth", configAuth.facebookAuth.clientSecret)
console.log("configAuth", configAuth.facebookAuth.callbackURL)

// console.log("inside passport config:", passport);
